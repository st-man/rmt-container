...
RUN crontab -l | { cat; echo "10 * * * * rsync -ave '"ssh -p 22"' --delete --exclude '*.json' ${RSYNC_USER}@${RMT_REMOTE_HOST}:/var/lib/rmt/public/* /var/lib/rmt/public/ && rmt-cli import repos /var/lib/rmt/public/repo/"; } | crontab -
